...
const DetailOrderPage = () => {
    ...
    const fetchDetailsOrder = async () => {
      ...
      const queryOrder = useQuery({queryKey: ["orders-details"], queryFn: fetchDetailsOrder, enabled: !!id && !!state?.token});
    ...
    <Loading isLoading={isPending}>
      ...
      <div style={{ width: '1270px', margin: '0 auto' }}>
        ...
        <WrapperHeaderUser>
          ...
          <WrapperContentInfo>
            <div className='name-info'><span>Người nhận: </span>{data?.shippingAddress?.fullName}</div>
